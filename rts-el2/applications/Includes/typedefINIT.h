...
typedef enum
{
    ...
    //低于相应值表示DAC为不输出状态
    _L_MIN_LEVEL,  //[32]启动判断DAC是否有效的最低电压值(1.0V-3.0V)
    __LIGHT_MAX
} ENV_LIGHT_T;
...
typedef enum
{
    ...
    //Channel-1相关数据
    //DAC相关
    _S_CH1_DAC_ADC,  //ADC读取的CH-1的DAC的采集值
    _S_CH1_DAC_VAL,  //ADC读取的CH-1的DAC的转换电压值
    _S_CH1_DAC_STA,  //CH-1的实际工作状态
    //温度相关
    ...
    //灯光控制相关
    _S_CH1_LT_SHUT_C,  //CH-1灯光的关闭-当前状态
    _S_CH1_LT_SHUT_P,  //CH-1灯光的关闭-临时状态
    _S_CH1_LT_DIM_C,  //CH-1灯光的50%调节-当前状态
    _S_CH1_LT_DIM_P,  //CH-1灯光的50%调节-临时状态
    _S_CH1_LT_ALM,  //CH-1灯光的报警状态
    _S_CH1_LT_STA,  //CH-1灯光的工作状态
    _S_CH1_LT_ON,  //CH-1灯光的开启时间
    _S_CH1_LT_OFF,  //CH-1灯光的关闭时间
    //灯光日升日落相关
    _S_CH1_LT_RISE,  //CH-1灯光的日升启动时间
    _S_CH1_LT_SET,  //CH-1灯光的日落启动时间
    _S_CH1_RS_RISE,  //CH-1灯光的日升时间
    _S_CH1_RS_SET,  //CH-1灯光的日落时间
    _S_CH1_RS_STA,  //CH-1灯光的日升日落状态标记
    _S_CH1_RS_CUR,  //CH-1灯光的日升日落的启动值
    _S_CH1_RS_TUR,  //CH-1灯光的日升日落的目标值
    _S_CH1_RS_SMP,  //CH-1灯光的日升日落的每份时间长度
    _S_CH1_RS_TMP,  //CH-1灯光的日升日落的总工作时间长度
    _S_CH1_RS_TIM,  //CH-1灯光的日升日落的操作计时
    _S_CH1_RS_DIR,  //CH-1灯光的日升日落方向
    _S_CH1_RS_OPT,  //CH-1灯光的日升日落的操作标记
    //灯光操作指令
    _S_CH1_OPT_EN,  //CH-1灯光操作标记
    _S_CH1_OPT_STA,  //CH-1灯光操作状态
    _S_CH1_OPT_VAL,  //CH-1灯光操作亮度
    _S_CH1_OPT_DT,  //CH-1灯光操作延时
    //LED灯相关
    _S_LED_CH1,  //线路1的LED灯光状态
    _S_LED_TA1,  //线路1的LED灯光状态
    //Channel-2相关数据
    _S_CH2_DAC_ADC,  //ADC读取的CH-2的DAC的采集值
    _S_CH2_DAC_VAL,  //ADC读取的CH-2的DAC的转换电压值
    _S_CH2_DAC_STA,  //CH-2的实际工作状态
    //温度相关
    ...
    //灯光控制相关
    _S_CH2_LT_SHUT_C,  //CH-2灯光的关闭-当前状态
    _S_CH2_LT_SHUT_P,  //CH-2灯光的关闭-临时状态
    _S_CH2_LT_DIM_C,  //CH-2灯光的50%调节-当前状态
    _S_CH2_LT_DIM_P,  //CH-2灯光的50%调节-临时状态
    _S_CH2_LT_ALM,  //CH-2灯光的报警状态
    _S_CH2_LT_STA,  //CH-2灯光的工作状态
    _S_CH2_LT_ON,  //CH-2灯光的开启时间
    _S_CH2_LT_OFF,  //CH-2灯光的关闭时间
    //灯光日升日落相关
    _S_CH2_LT_RISE,  //CH-2灯光的日升启动时间
    _S_CH2_LT_SET,  //CH-2灯光的日落启动时间
    _S_CH2_RS_RISE,  //CH-2灯光的日升时间
    _S_CH2_RS_SET,  //CH-2灯光的日落时间
    _S_CH2_RS_STA,  //CH-2灯光的日升日落状态标记
    _S_CH2_RS_CUR,  //CH-2灯光的日升日落的启动值
    _S_CH2_RS_TUR,  //CH-2灯光的日升日落的目标值
    _S_CH2_RS_SMP,  //CH-2灯光的日升日落的每份时间长度
    _S_CH2_RS_TMP,  //CH-2灯光的日升日落的总工作时间长度
    _S_CH2_RS_TIM,  //CH-2灯光的日升日落的操作计时
    _S_CH2_RS_DIR,  //CH-2灯光的日升日落方向
    _S_CH2_RS_OPT,  //CH-2灯光的日升日落的操作标记
    //灯光操作指令
    _S_CH2_OPT_EN,  //CH-2灯光操作标记
    _S_CH2_OPT_STA,  //CH-2灯光操作状态
    _S_CH2_OPT_VAL,  //CH-2灯光操作亮度
    _S_CH2_OPT_DT,  //CH-2灯光操作延时
    //LED灯相关
    _S_LED_CH2,  //线路2的LED灯光状态
    _S_LED_TA2,  //线路2的LED灯光状态
    //状态值数量
    __STA_MAX  //状态值数量
} ENV_STA_T;
...
#define SYS_CONFIG_ADDRESS ((rt_uint32_t)0x0803F000)
//Address(1F400 -- 1F800 -- 1FC00 -- 20000
#define SYS_LOGS_ADDRESS ((rt_uint32_t)0x0803F800)
